...
function addManager()
{
    ...
    if (firstName.length == 0 || lastName.length == 0||telephone.length==0||email.length==0||username.length==0||password.length==0) {
...
function modManager(obj){
    ...
    if(obj.value == "modify"){
        ...
        operatorCell3.innerHTML ="<input  style='width:120px' class='form-control' value='"+operatorCell3.innerHTML+"'/>";
